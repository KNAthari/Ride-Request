...
class RideRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ride_request" do
    assert_difference("RideRequest.count") do
      post ride_requests_url, params: { ride_request: { email: @ride_request.email, location: @ride_request.location, name: @ride_request.name, notes: @ride_request.notes, pickup_time: @ride_request.pickup_time } }
    end
  ...
  test "should update ride_request" do
    patch ride_request_url(@ride_request), params: { ride_request: { email: @ride_request.email, location: @ride_request.location, name: @ride_request.name, notes: @ride_request.notes, pickup_time: @ride_request.pickup_time } }
